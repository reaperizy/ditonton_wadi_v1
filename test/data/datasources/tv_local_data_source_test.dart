...
void main() {  late TvLocalDataSourceImpl dataSourcetv;
late MockDatabaseHelperTelevision mockDatabaseHelperTelevision;

setUp(() {
  mockDatabaseHelperTelevision = MockDatabaseHelperTelevision();
  dataSourcetv = TvLocalDataSourceImpl(databaseHelpertv: mockDatabaseHelperTelevision);
});
...
group('Get TV Detail By Id', () {
  ...
  test('should return null when data is not found', () async {
    // arrange
    when(mockDatabaseHelperTelevision.getTvById(tId)).thenAnswer((_) async => null);
    // act
    final result = await dataSourcetv.getTvById(tId);
    // assert
    expect(result, null);
